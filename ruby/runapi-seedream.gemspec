...
Dir.chdir(__dir__) do
  ...
  Gem::Specification.new do |spec|
    ...
    spec.summary = "Seedream API Ruby SDK for RunAPI"
    spec.description = "The seedream api Ruby SDK is the language-specific package for Seedream on RunAPI. Use this seedream api package for text-to-image, image editing, and creative production flows when your application needs JSON request bodies, task status lookup, and consistent RunAPI errors in Ruby."
